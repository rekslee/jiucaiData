...
def get_yesterday(format="%Y-%m-%d"):
    ...
    return datetime.strftime(yesterday, format)
...
def get_10year_ago(format="%Y-%m-%d"):
    today = datetime.today()
    ten_year_ago = today + relativedelta(years=-10)
    return datetime.strftime(ten_year_ago, format)
    
def get_20year_ago(format="%Y-%m-%d"):
    today = datetime.today()
    twenty_year_ago = today + relativedelta(years=-20)
    return datetime.strftime(twenty_year_ago, format)
